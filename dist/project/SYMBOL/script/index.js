...
ani3.from('.sect4 .motive b', { autoAlpha: 0, yPercent: -200, duration: 0.5 }, 'text')
    .from('.sect4 .motive img', { autoAlpha: 0, delay: 0.5, duration: 0.5 }, 'text')
    .from('.sect4 .logo b', { autoAlpha: 0, delay:1, duration: 0.5 }, 'text')
    .from('.sect4 .logo figure', { autoAlpha: 0, delay: 1.5, duration: 0.5 }, 'text')
ScrollTrigger.create({
    animation: ani3,
    trigger: '.sect4',
    toggleActions: 'play pause none',
